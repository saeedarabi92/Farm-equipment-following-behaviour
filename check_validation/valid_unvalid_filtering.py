...
video_folder = file_wd + '/videos/2020_videos'
csv_folder = file_wd + '/CSVs/2020_CSVs'
video_files = glob.glob(video_folder + '/*')
csv_files = glob.glob(csv_folder + '/*')
valid_frame_folder = file_wd + '/valid_unvalid_files/2020_valid_unvalid_frames/valid_frames'
unvalid_frame_folder = file_wd + '/valid_unvalid_files/2020_valid_unvalid_frames/unvalid_frames'
video_folder = file_wd + '/videos/2020_videos'
